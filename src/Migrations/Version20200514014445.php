 ...
 */
final class Version20200514014445 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE seance (id INT NOT NULL, realisation_id INT NOT NULL, titre VARCHAR(255) NOT NULL, description TEXT NOT NULL, durée VARCHAR(255) DEFAULT NULL, temps DATE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE cours (id INT NOT NULL, nom_cours VARCHAR(255) NOT NULL, description TEXT DEFAULT NULL, objectif TEXT DEFAULT NULL, tag VARCHAR(255) DEFAULT NULL, competences_req TEXT DEFAULT NULL, niveau VARCHAR(255) DEFAULT NULL, image VARCHAR(255) DEFAULT NULL, date_creation DATE NOT NULL, dernier_modification DATE NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE etudiant (id INT NOT NULL, usercode_id INT NOT NULL, matricule VARCHAR(255) NOT NULL, filiere VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE proposition (id INT NOT NULL, cours_id INT NOT NULL, tuteur_id INT NOT NULL, titre VARCHAR(255) NOT NULL, description TEXT DEFAULT NULL, date_creation DATE NOT NULL, date_modification DATE NOT NULL, statut VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE realisation (id INT NOT NULL, proposition_id INT NOT NULL, cours_id INT NOT NULL, titre VARCHAR(255) NOT NULL, desicription TEXT DEFAULT NULL, date_creation DATE NOT NULL, date_modification DATE NOT NULL, PRIMARY KEY(id))');
