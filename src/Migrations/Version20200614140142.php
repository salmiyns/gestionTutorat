 ...
 */
final class Version20200614140142 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE "user" (id INT NOT NULL, email VARCHAR(60) NOT NULL, password VARCHAR(64) NOT NULL, is_active BOOLEAN NOT NULL, firstname VARCHAR(255) DEFAULT NULL, token VARCHAR(255) DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, activated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
