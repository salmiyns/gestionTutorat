 ...
 */
final class Version20200507135124 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE etudiant (id INT NOT NULL, user_id_id INT NOT NULL, user_id INT NOT NULL, matricule VARCHAR(255) NOT NULL, filiere VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
