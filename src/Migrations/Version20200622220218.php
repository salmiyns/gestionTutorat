 ...
 */
final class Version20200622220218 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE proposition (id INT NOT NULL, tuteur_id INT DEFAULT NULL, titre VARCHAR(255) NOT NULL, description TEXT DEFAULT NULL, date_creation DATE NOT NULL, date_modification DATE NOT NULL, statut VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
