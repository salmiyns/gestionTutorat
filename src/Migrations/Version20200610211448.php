 ...
 */
final class Version20200610211448 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE enseignant (id INT NOT NULL, user_id_id INT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, first_name VARCHAR(255) DEFAULT NULL, last_name VARCHAR(255) DEFAULT NULL, date_of_birth VARCHAR(255) NOT NULL, profile_pic VARCHAR(255) DEFAULT NULL, activation_code VARCHAR(255) DEFAULT NULL, registration_date DATE DEFAULT NULL, status VARCHAR(255) NOT NULL, telephone VARCHAR(255) DEFAULT NULL, sexe VARCHAR(255) NOT NULL, adresse VARCHAR(255) DEFAULT NULL, about TEXT DEFAULT NULL, titre VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
