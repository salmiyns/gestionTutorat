 ...
 */
final class Version20200507221049 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE seance (id INT NOT NULL, realisation_id INT NOT NULL, titre VARCHAR(255) NOT NULL, description TEXT NOT NULL, durée VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
