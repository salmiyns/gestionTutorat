 ...
 */
final class Version20200527205054 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE realisation (id INT NOT NULL, proposition_id INT NOT NULL, cours_id INT NOT NULL, tuteur_id INT NOT NULL, titre VARCHAR(255) NOT NULL, desicription TEXT DEFAULT NULL, date_creation DATE NOT NULL, date_modification DATE NOT NULL, PRIMARY KEY(id))');
