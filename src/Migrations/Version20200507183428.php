 ...
 */
final class Version20200507183428 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE cours (id INT NOT NULL, proposition_id INT NOT NULL, nom_cours VARCHAR(255) NOT NULL, description TEXT DEFAULT NULL, objectif TEXT DEFAULT NULL, tag VARCHAR(255) DEFAULT NULL, compétences_req TEXT DEFAULT NULL, niveau VARCHAR(255) DEFAULT NULL, image VARCHAR(255) DEFAULT NULL, date_creation DATE NOT NULL, dernier_modification DATE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE tuteur (id INT NOT NULL, id_etudiant_id INT NOT NULL, proposition_id INT NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE proposition (id INT NOT NULL, titre VARCHAR(255) NOT NULL, deiscription TEXT DEFAULT NULL, date_creation DATE NOT NULL, date_modification DATE NOT NULL, PRIMARY KEY(id))');
