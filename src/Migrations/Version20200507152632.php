 ...
 */
final class Version20200507152632 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE etudiant (id INT NOT NULL, user_id INT NOT NULL, username_id INT NOT NULL, matricule VARCHAR(255) NOT NULL, filiere VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE proposition (id INT NOT NULL, tuteur_id INT NOT NULL, cours INT NOT NULL, date_creation DATE NOT NULL, date_modification DATE NOT NULL, titre VARCHAR(255) NOT NULL, description TEXT DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_C7CDC35386EC68D8 ON proposition (tuteur_id)');
        $this->addSql('CREATE TABLE enseignant (id INT NOT NULL, user_id_id INT NOT NULL, user_id INT NOT NULL, PRIMARY KEY(id))');
